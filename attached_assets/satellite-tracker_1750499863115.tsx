...
export default function SatelliteTracker() {
  ...
  const satellites: SatelliteData[] = [
    ...
    },
    {
      ...
      country: "USA",
      description:
        "Space telescope that has revolutionized astronomy with deep space observations",
    },
  ];
  ...
  const filteredSatellites = satellites.filter((satellite) => {
    ...
    const matchesSearch = satellite.name
      .toLowerCase()
        ...
        <div className="container mx-auto px-4 py-8 space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Track real-time positions of satellites, space stations, and space
              debris with detailed flyover predictions
            </p>
          </div>
          ...
          <div className="flex justify-center items-center gap-4">
            {locationLoading ? (
              <Badge
                variant="outline"
                className="text-sm px-4 py-2 bg-blue-500/10 border-blue-500/30"
              >
              ...
              <Badge
                variant="outline"
                className="text-sm px-4 py-2 bg-orange-500/10 border-orange-500/30"
              >
                <MapPin className="w-4 h-4 mr-2" />
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <p className="font-semibold">
                          {satellite.position.altitude} km
                        </p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Speed</p>
                        <p className="font-semibold">
                          {satellite.velocity.speed.toLocaleString()} km/h
                        </p>
                      </div>
                    </div>
